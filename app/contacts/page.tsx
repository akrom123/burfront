    ...
    <>
      <div className="container">
        ...
        <div className={styles.contacts}>
          <div className={`${styles.contactsCard} ${styles.contactsCardYellow}`}>
          ...
          <div className={styles.contactsTelegram}>
            <div className={`${styles.contactsCard} ${styles.contactsCardTelegram1}`}>
              <Icon name="telegram" size={44} />
              <div className={styles.contactsCardLink}>Telegram Channel</div>
            </div>
            <div className={`${styles.contactsCard} ${styles.contactsCardTelegram2}`}>
              <Icon name="telegram" size={44} />
              <div className={styles.contactsCardLink}>Telegram Support</div>
            </div>
          </div>
          <div className={`${styles.contactsCard} ${styles.contactsCardEmail}`}>
            <div className={styles.contactsCardTitle}>Name Site ltd</div>
